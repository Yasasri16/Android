...
public class MainActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button forfeit = findViewById(R.id.forfeitid);
        Button done = findViewById(R.id.doneid);
        sharebutton= findViewById(R.id.sharebutton);
        fetchdareQuestion("pg13");
        ...
        sharebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(MainActivity6.this, FeedBack.class);
                startActivity(i);
            }
        });
    ...
    private void fetchdareQuestion(String rating) {
        DareRetrofitInstance.getDareRetrofitInstance().getDareApiInterface().getDare(rating).enqueue(new Callback<Model>() {
            @Override
